...
import { ROLE_LABELS, isManagerRole, isSpeakerRole, normalizeRole } from "@/lib/roles";
          ...
          {user ? (
            <>
              <details className="group relative">
                <summary className="nav-link cursor-pointer list-none">My Learning ▾</summary>
                <div className="absolute right-0 top-9 z-50 w-64 rounded-2xl border border-slate-200 bg-white p-3 shadow-xl">
                  ...
                  <Link href="/dashboard" className="block rounded-lg px-3 py-2 hover:bg-slate-100">Role dashboard</Link>
              ...
              {isSpeakerRole(role) ? (
                <details className="group relative">
                  <summary className="nav-link cursor-pointer list-none">Speaker ▾</summary>
                  <div className="absolute right-0 top-9 z-50 w-64 rounded-2xl border border-slate-200 bg-white p-3 shadow-xl">
              ...
              {isManagerRole(role) ? (
                <details className="group relative">
                  <summary className="nav-link cursor-pointer list-none">Management ▾</summary>
