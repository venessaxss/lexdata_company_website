      ...
      <form action={createCourse} className="card mt-8 space-y-5 p-6">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <div>
            ...
            <input type="number" name="price_cents" defaultValue="0" className="input mt-2" placeholder="0 or 9900" />
          </div>
          <div>
            <label className="label">Currency</label>
            <input name="currency" defaultValue="usd" className="input mt-2" />
          </div>
          <div>
            <label className="label">Stripe price ID</label>
            <input name="stripe_price_id" className="input mt-2" placeholder="optional price_xxx" />
          </div>
        </div>
