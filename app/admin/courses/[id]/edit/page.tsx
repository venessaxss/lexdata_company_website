      ...
      <form action={updateAction} className="card mt-8 space-y-5 p-6">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <div>
            ...
            <input type="number" name="price_cents" defaultValue={course.price_cents ?? 0} className="input mt-2" />
          </div>
          <div>
            <label className="label">Currency</label>
            <input name="currency" defaultValue={course.currency ?? "usd"} className="input mt-2" />
          </div>
          <div>
            <label className="label">Stripe price ID</label>
            <input name="stripe_price_id" defaultValue={course.stripe_price_id ?? ""} className="input mt-2" />
          </div>
        </div>
